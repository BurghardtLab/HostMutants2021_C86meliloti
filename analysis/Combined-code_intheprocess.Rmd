...
```{r Create additional panel and combine with existing heatmap, echo=TRUE}

#adding the panel for relative strain fitness
#Selecting the data cols
Geno.Coef.RDA1<-Geno.Coef.RDA %>% select(c(Trait,Predictor,Class))
#Generating new rows
...
#Combine
Geno.Coef.RDA1<-rbind(Geno.Coef.RDA1,Newrows)%>%column_to_rownames(var="Predictor")
# replace "None" values with 0,"Change" with "1"
Geno.Coef.RDA1[is.na(Geno.Coef.RDA1)|Geno.Coef.RDA1=="Change"]<- 1
Geno.Coef.RDA1[is.na(Geno.Coef.RDA1)|Geno.Coef.RDA1=="None"]<- 0
#Convert it to a matrix
mat <- as.matrix(t(Geno.Coef.RDA1[, 2]))
#Construct the heatmap1
q=Heatmap(t(as.matrix(Geno_matrix)))
#Construct the heatmap2
p=Heatmap((mat))
#combine the heatmaps
p%v%q
#getting an error:x' must have at least 2 rows and 2 columns/x must be a numeric blah blah
```
