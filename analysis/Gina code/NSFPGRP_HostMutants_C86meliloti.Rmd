...
pdf(file="../figures/heatmap_base_mean_all.pdf",width = 12,height=8)
...
ggsave("../figures/rda_r108_rda1.png", rda.plot, height = 6 , width = 10, dpi=300)
...
pdf(file="../figures/heatmap_adj_mean_r108_WT.pdf",width = 12,height=8)
h<-heatmap.2(as.matrix(fit.subtract), col=pal, trace="none", scale="row", cexCol = .5,cexRow = .75)
dev.off()
