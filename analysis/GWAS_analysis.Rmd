...
```{r creating the crossranked tables, echo=FALSE}
  ...
  #Step1: define plant gene
  #Step2: define replicon
  
  #Step3: Incorporate the data:combined_top10data_replicon<-
  #Step4: Create the crossranked table
...
```{r creating thE TOP 10 CANDIDATES AGAIN, echo=FALSE}


top10candidates<-function(mutantline,replicon){
  
  #Step 1 :create a list of the mutant lines
  #Step 2:create a list of the replicons involved
  #step3: create the top 10 candidate gene list
