...
within_rank10_counts <- rowSums(top5_candidates_crossranked[, -(1:6)] <= 10, na.rm = TRUE)
top5_candidates_crossranked<-cbind(top5_candidates_crossranked,within_rank10_counts)

write.table(top5_candidates_crossranked,file="/Users/sohiniguha/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/Sohini&Liana/GitHub/HostMutants2021_C86meliloti/tables/SupplementalTable S8.tsv",sep = "\t",row.names = FALSE)
