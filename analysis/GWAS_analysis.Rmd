...
df <- function(replicon) {
  ...
  separated <- top5_candidates_crossranked %>%
    separate(Location, c("Organism", "Replicon"))
  
  # Filter the data for the specified replicon
  result <- separated[separated$Replicon == replicon, ]
  ...
  # Generate heatmap
  heatmap.2(data_matrix, Rowv = TRUE, Colv = TRUE, col = pal, 
