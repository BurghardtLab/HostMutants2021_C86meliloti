...
merged<- list(merged_psyma_ipd3.change,
...
#merged<-merged%>%separate(Location,c("Organism","Replicon"))
...
x<- as.data.frame(merged[(merged[,run]),])
 #split col2 
 #rename the col replicon
merge_genewise <- function(x) {
    lapply(merged,function(x)x[match(unique(top10$ld_group),x$ld_group),]$pr)
  
return(merge_genewise)}
...
dnf3<- data.frame(group=top10_chr_dnf3[match(unique(top10_chr_dnf3$ld_group),top10_chr_dnf3$ld_group),]$ld_group,pr=top10_chr_dnf3[match(unique(top10_chr_dnf3$ld_group),top10_chr_dnf3$ld_group),]$pr,Location= top10_chr_dnf3[match(unique(top10_chr_dnf3$ld_group),top10_chr_dnf3$ld_group),]$chr,Pval=top10_chr_dnf3[match(unique(top10_chr_dnf3$ld_group),top10_chr_dnf3$ld_group),]$p_lrt,Beta=top10_chr_dnf3[match(unique(top10_chr_dnf3$ld_group),top10_chr_dnf3$ld_group),]$beta,Br=top10_chr_dnf3[match(unique(top10_chr_dnf3$ld_group),top10_chr_dnf3$ld_group),]$br,WTrank= A17_combined[match(unique(top10_chr_dnf3$ld_group),A17_combined$ld_group),]$pr,hclrank=hcl_combined[match(unique(top10_chr_dnf3$ld_group),hcl_combined$ld_group),]$pr,ipd3rank=ipd3_combined[match(unique(top10_chr_dnf3$ld_group),ipd3_combined$ld_group),]$pr,latdrank=latd_combined[match(unique(top10_chr_dnf3$ld_group),latd_combined$ld_group),]$pr,nad1rank=nad1_combined[match(unique(top10_chr_dnf3$ld_group),nad1_combined$ld_group),]$pr,dnf1rank=dnf1_combined[match(unique(top10_chr_dnf3$ld_group),dnf1_combined$ld_group),]$pr,dnf2rank=dnf2_combined[match(unique(top10_chr_dnf3$ld_group),dnf2_combined$ld_group),]$pr,dnf3rank=dnf3_combined[match(unique(top10_chr_dnf3$ld_group),dnf3_combined$ld_group),]$pr,dnf4rank=dnf4_combined[match(unique(top10_chr_dnf3$ld_group),dnf4_combined$ld_group),]$pr,dnf6rank=dnf6_combined[match(unique(top10_chr_dnf3$ld_group),dnf6_combined$ld_group),]$pr,dnf7rank=dnf7_combined[match(unique(top10_chr_dnf3$ld_group),dnf7_combined$ld_group),]$pr,dnf1dnf2rank=dnf1dnf2_combined[match(unique(top10_chr_dnf3$ld_group),dnf1dnf2_combined$ld_group),]$pr,dnf5dnf2rank=dnf5dnf2_combined[match(unique(top10_chr_dnf3$ld_group),dnf5dnf2_combined$ld_group),]$pr,rdn1rank=rdn1_combined[match(unique(top10_chr_dnf3$ld_group),rdn1_combined$ld_group),]$pr,sunn1rank=sunn1_combined[match(unique(top10_chr_dnf3$ld_group),sunn1_combined$ld_group),]$pr,sunn4rank=sunn4_combined[match(unique(top10_chr_dnf3$ld_group),sunn4_combined$ld_group),]$pr,Description=top10_chr_dnf3[match(unique(top10_chr_dnf3$ld_group),top10_chr_dnf3$ld_group),]$description)



#what needs to be matched
top10[match(unique(top10$ld_group),top10$ld_group),]$ld_group


#to what should the matching be


#first part of the crossranked table
data.frame(group=top10[match(unique(top10$ld_group),top10$ld_group),]$ld_group,pr=top10[match(unique(top10$ld_group),top10$ld_group),]$pr,Location= top10[match(unique(top10$ld_group),top10$ld_group),]$chr,Pval=top10[match(unique(top10$ld_group),top10$ld_group),]$p_lrt,Beta=top10[match(unique(top10$ld_group),top10$ld_group),]$beta,Br=top10[match(unique(top10$ld_group),top10$ld_group),]$br,Description=top10[match(unique(top10$ld_group),top10$ld_group),]$description)
