...
ggsave("../figures/rda_r108_rda1pc1.png", rda.plot, height = 6 , width = 10, dpi=300)
...
fit.subtract <- fit.subtract[,-87]
#pdf(file="../figures/heatmap_adj_mean_r108.pdf",width = 12,height=8)
h<-heatmap.2(as.matrix(fit.subtract), col=pal, trace="none", scale="row", cexCol = .5,cexRow = .75)
dev.off()
...
fit.subtract <- column_to_rownames(fit.subtract, "name")
fit.subtract <- fit.subtract[,-87]
pdf(file="../figures/heatmap_adj_mean_a17.pdf",width = 12,height=8)
h<-heatmap.2(as.matrix(fit.subtract), col=pal, trace="none", scale="row", cexCol = .5,cexRow = .75)
dev.off()
```
