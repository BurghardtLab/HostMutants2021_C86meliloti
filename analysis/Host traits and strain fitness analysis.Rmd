...
```{r Code for generating Table S2, echo=TRUE}
...
```{r Code for generating Tables S3 and S4, echo=FALSE}
...
```{r Code for creating Tables S5 and S6,echo=FALSE}
...
```{r Code for creating FigS4, echo=TRUE}
#Fig S4a
