...
df1 <- read.delim("../data/M843A_vs_A17.paf", header=FALSE, fill=TRUE, sep="\t")
                # Column mapping for PAF:
# V1 = query (contig)
# V2 = query length
# V3 = query start
# V4 = query end
...
ggplot(df1, aes(x=V8, y=V3, color=V5)) +
  geom_point(alpha=0.6) +
  theme_bw() +
  labs(x="Reference position", y="Contig position", color="Strand")
```