...
```{r code for creating Supplemental Figure 3, echo=TRUE}
...
pdf(file = "../figures/Supplemental Figure 3.pdf",width = 6, height = 6)
Coef.Prop.Figure
dev.off()
...
```{r Code for creating the Supplemental Figure 2}
# Correlation Plot
pdf(file = "../figures/Supplemental Figure 2.pdf",width = 9, height = 9)
