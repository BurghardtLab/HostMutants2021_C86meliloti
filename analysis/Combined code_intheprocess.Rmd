...
# There is no need to run these inside the function. You can just have a my pal argument  
...
trait.boxplot(trait = "total_nodule_area_per_plant")
...
pdf(file = "../figures/nodule_number_per_plant.pdf",width = 6, height = 6)
pdf(file = "../figures/total_nodule_area_per_plant.pdf",width = 6, height = 6)
pdf(file = "../figures/average_area_per_nodule.pdf",width = 6, height = 6)
pdf(file = "../figures/root_to_shoot_ratio.pdf",width = 6, height = 6)
pdf(file = "../figures/total_biomass_per_plant.pdf",width = 6, height = 6)
pdf(file = "../figures/cfu_per_nodule_LOG10.pdf",width = 6, height = 6)
pdf(file = "../figures/cfu_per_plant_LOG10.pdf",width = 6, height = 6)
