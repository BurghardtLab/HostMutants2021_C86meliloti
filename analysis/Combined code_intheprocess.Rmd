...
```{r Write Function to extract Statistical summary on genotype coefficients, echo=TRUE}
#for troubleshooting
...
extract.coefs(trait = "total_biomass",predictor="type", p.threshold=0.001)
extract.coefs(trait = "nodules_perplant",predictor="type")
