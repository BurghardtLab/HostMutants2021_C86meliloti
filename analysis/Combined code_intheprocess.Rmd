...
pdf(file = "../figures/Supplemental Figure1.pdf",width = 6, height = 6)
hist(t(freq_initial),breaks = 10, main= "Initial strain frequency distribution")
dev.off()
...
write.table (Geno.Coef.Summary,file="../tables/Supplemental Table S2.txt",sep = "\t",row.names = FALSE)
...
write.table (ANOVA.Trait.Summary,file="../tables/Supplemental Table S4.txt",sep = "\t",row.names = FALSE)
