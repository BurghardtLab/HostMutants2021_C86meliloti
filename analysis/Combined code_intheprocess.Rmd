...
write.table (Geno.Coef.RDA,file="../tables/Supplemental Table S2.txt",sep = "\t",row.names = FALSE)
write.table (Type.Coef.RDA,file="../tables/Supplemental Table S3.txt",sep = "\t",row.names = FALSE)
...
pdf(file = "../figures/Figure2_Heatmap_SymbioticTraits.pdf",width = 6, height = 3)
...
```{r code for creating Fig 5, echo=TRUE}
...
pdf(file = "../figures/Figure4_RDA_A17Background.pdf",width = 5, height = 5)
